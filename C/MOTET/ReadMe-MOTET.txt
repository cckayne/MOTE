...
Example: >motet HDYZWRQZZTQLIMQBZWZNJTNOPVZ "my strong key" d m a
Output : >my message
...
However, "more than good enough" justly describes MOTET, if only because it is built upon Bob Jenkins' expert PRNG insights and this author's 30-plus years' experience. 

I think you'll find that MOTET proves how _easy_ truly strong cryptography is to implement, while avoiding all those NIST/academic offerings with their NSA backdoors.
